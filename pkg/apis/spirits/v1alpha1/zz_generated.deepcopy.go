...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NamedSpiritAction) DeepCopyInto(out *NamedSpiritAction) {
	*out = *in
	in.Action.DeepCopyInto(&out.Action)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamedSpiritAction.
func (in *NamedSpiritAction) DeepCopy() *NamedSpiritAction {
	if in == nil {
		return nil
	}
	out := new(NamedSpiritAction)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SpiritActionChoices) DeepCopyInto(out *SpiritActionChoices) {
	*out = *in
	if in.Actions != nil {
		...
		*out = make([]NamedSpiritAction, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
