...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ActionCallList)(nil), (*input.ActionCallList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ActionCallList_To_input_ActionCallList(a.(*ActionCallList), b.(*input.ActionCallList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*input.ActionCallList)(nil), (*ActionCallList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_input_ActionCallList_To_v1alpha1_ActionCallList(a.(*input.ActionCallList), b.(*ActionCallList), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ActionCallList_To_input_ActionCallList(in *ActionCallList, out *input.ActionCallList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]input.ActionCall)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1alpha1_ActionCallList_To_input_ActionCallList is an autogenerated conversion function.
func Convert_v1alpha1_ActionCallList_To_input_ActionCallList(in *ActionCallList, out *input.ActionCallList, s conversion.Scope) error {
	return autoConvert_v1alpha1_ActionCallList_To_input_ActionCallList(in, out, s)
}

func autoConvert_input_ActionCallList_To_v1alpha1_ActionCallList(in *input.ActionCallList, out *ActionCallList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]ActionCall)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_input_ActionCallList_To_v1alpha1_ActionCallList is an autogenerated conversion function.
func Convert_input_ActionCallList_To_v1alpha1_ActionCallList(in *input.ActionCallList, out *ActionCallList, s conversion.Scope) error {
	return autoConvert_input_ActionCallList_To_v1alpha1_ActionCallList(in, out, s)
}
