...
func (c *actionServiceClient) CreateAction(ctx context.Context, in *CreateActionRequest, opts ...grpc.CallOption) (*CreateActionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/spirits.v1.ActionService/CreateAction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *actionServiceClient) GetAction(ctx context.Context, in *GetActionRequest, opts ...grpc.CallOption) (*GetActionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/spirits.v1.ActionService/GetAction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *actionServiceClient) ListActions(ctx context.Context, in *ListActionsRequest, opts ...grpc.CallOption) (*ListActionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/spirits.v1.ActionService/ListActions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *actionServiceClient) UpdateAction(ctx context.Context, in *UpdateActionRequest, opts ...grpc.CallOption) (*UpdateActionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/spirits.v1.ActionService/UpdateAction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *actionServiceClient) DeleteAction(ctx context.Context, in *DeleteActionRequest, opts ...grpc.CallOption) (*DeleteActionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/spirits.v1.ActionService/DeleteAction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ActionService_CreateAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spirits.v1.ActionService/CreateAction",
	}
...
func _ActionService_GetAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spirits.v1.ActionService/GetAction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ActionService_ListActions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spirits.v1.ActionService/ListActions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ActionService_UpdateAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spirits.v1.ActionService/UpdateAction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ActionService_DeleteAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spirits.v1.ActionService/DeleteAction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ActionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "spirits.v1.ActionService",
	...
	Metadata: "spirits/v1/action.proto",
}
