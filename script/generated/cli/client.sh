...
${BOLD}${WHITE}spirits command line client (API version 0.0.0)${OFF}
...
print_about() {
    echo ""
    echo -e "${BOLD}${WHITE}spirits command line client (API version 0.0.0)${OFF}"
    echo ""
    echo -e "License: "
    echo -e "Contact: "
    echo ""
...
print_version() {
    echo ""
    echo -e "${BOLD}spirits command line client (API version 0.0.0)${OFF}"
    echo ""
}
