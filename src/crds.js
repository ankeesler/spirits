            ...
            openAPIV3Schema: {
              ...
              properties: {
                ...
                spec: {
                  ...
                  properties: {
                    stats: {
                      ...
                      properties: {
                        health: {
                          description: 'A quantitative representation of the energy in the Spirit. When this drops to 0, the Spirit is no longer able to participate in a Battle.',
                          type: 'integer',
                          format: 'int64',
                          minimum: 1,
                        },
                ...
                status: {
                  ...
                  properties: {
                    conditions: {
                      description: 'Conditions is an array of the current observed Spirit status.',
                      type: 'array',
                      items: {
